...
function HeroSection() {
  ...
  return (
    <section className="relative bg-midnight overflow-hidden px-5">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center pt-28 md:pt-32 pb-14 md:pb-20">
        {/* Language toggle — THE FEATURE, first thing */}
        <div className="mb-5">
        ...
        {/* GIANT brand name — centered, nothing competing */}
        ...
        {/* Headshot as a divider element between name and subhead */}
        <div className="flex items-center justify-center gap-4 my-5">
          <div className="h-[1px] flex-1 max-w-[100px] bg-gradient-to-r from-transparent to-oro/30" />
          <div className="relative w-[64px] h-[64px] md:w-[80px] md:h-[80px] rounded-full overflow-hidden border-2 border-oro/50 shadow-[0_0_30px_rgba(212,165,32,0.12)] shrink-0">
            <Image
          ...
          <div className="h-[1px] flex-1 max-w-[100px] bg-gradient-to-l from-transparent to-oro/30" />
        </div>
        ...
        <div className="mt-5 text-[10px] text-white/15 tracking-wide">
