    ...
    <section className="bg-midnight py-14 md:py-16 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-5 md:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-white/55 text-[12px]">{t("Why timing and pricing strategy matter", "Por qué la estrategia de tiempo y precio importa")}</p>
        </div>
        <div className="grid grid-cols-3 gap-4 md:gap-8">
          <div ref={price.ref} className="text-center">
            ...
            <div className="text-white/55 text-[10px] md:text-[11px] mt-1">{t("Median Price", "Precio Medio")}</div>
          ...
          <div ref={days.ref} className="text-center">
            ...
            <div className="text-white/55 text-[10px] md:text-[11px] mt-1">{t("Avg. Days on Market", "Días Promedio")}</div>
          ...
          <div ref={change.ref} className="text-center">
            ...
            <div className="text-white/55 text-[10px] md:text-[11px] mt-1">{t("YoY Price Growth", "Crecimiento Anual")}</div>
